...
async function main() {
  ...
  manager.addNamedEntityText('technology', '.net', ['en'], ['.NET', 'dot net']);
  manager.addNamedEntityText('technology', 'amazon-api-gateway', ['en'], ['Amazon API Gateway', 'AWS API Gateway', 'API Gateway']);
  manager.addNamedEntityText('technology', 'angular', ['en'], ['angular', 'angularJS', 'Angular']);
  manager.addNamedEntityText('technology', 'chaos-engineering', ['en'], ['Chaos Engineering', 'chaos engineering']);
  manager.addNamedEntityText('technology', 'cloudformation', ['en'], ['cf', 'CloudFormation']);
  manager.addNamedEntityText('technology', 'elasticsearch-ltr', ['en'], ['elasticsearch', 'ElasticSearch']);
  manager.addNamedEntityText('technology', 'istio', ['en'], ['istio', 'Istio']);
  manager.addNamedEntityText('technology', 'java', ['en'], ['Java', 'Java8', 'Java 8', 'JDK']);
  manager.addNamedEntityText('technology', 'kubernetes', ['en'], ['k8n', 'Kubernetes']);
  manager.addNamedEntityText('technology', 'prophet', ['en'], ['prophet', 'Prophet']);
  manager.addNamedEntityText('technology', 'release_train', ['en'], ['release train', 'Release Train']);
  manager.addNamedEntityText('technology', 'service_mesh', ['en'], ['Service Mesh', 'service mesh']);
  manager.addNamedEntityText('technology', 'smart_contracts', ['en'], ['Smart Contract', 'smart contract']);
  manager.addNamedEntityText('technology', 'tendermint', ['en'], ['Tendermint', 'tendermint']);
  manager.addNamedEntityText('technology', 'terraform', ['en'], ['Terraform', 'Terraform']);
  manager.addNamedEntityText('technology', 'typescript', ['en'], ['typescript', 'Typescript', 'TypeScript']);

  // English validate technology
  manager.addDocument('en', 'Can i use %technology%?', 'en_get_tech_status');
  manager.addDocument('en', 'Is %technology% validated for new projects inside AXA', 'en_get_tech_status');
  manager.addDocument('en', 'Is it possible to develop with %technology%?', 'en_get_tech_status');
  manager.addDocument('en', 'Is %technology% approved?', 'en_get_tech_status');
  manager.addDocument('en', 'What is the status of %technology%?', 'en_get_tech_status');
  manager.addDocument('en', 'What\'s is the status of %technology%?', 'en_get_tech_status');

  manager.addAnswer('en', 'en_get_tech_status', 'The status of {{ technology }} is $status$');

  // English Get Tech Info
  manager.addDocument('en', 'Can you give more info on %technology%?', 'en_get_tech_info');
  manager.addDocument('en', 'Describe %technology%', 'en_get_tech_info');
  manager.addDocument('en', 'What do you think of %technology%?', 'en_get_tech_info');

  manager.addAnswer('en', 'en_get_tech_info', 'Here is more information on {{ technology }}: $description$');
  ...
  manager.addAnswer('en', 'en_help', "I am your radar assistant. You can ask me questions about the usage of a technology inside the company|What is the current status of Java?,Give me more information on Chaos Enginnering");
  manager.addAnswer('en', 'en_help', "I am glad to help. You can ask me questions about technology recommandations in the company|What is the current status of Terraform?,Give me more information on Typescript");
  ...
  //
  const result1 = await manager.process('en', 'What\'s the current status of Kubernetes', conversationContext);
  console.log(result1.answer, conversationContext);
}
